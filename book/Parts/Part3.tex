...
\begin{equation}
	...
	\begin{bmatrix}
	    1 + \frac{\Delta t}{2\Delta x}u_i^{k} & 0 & 0 & \dots  & - \left(\frac{\Delta t}{2\Delta x} u_{i-1}^{k}\right) \\
	    - \left(\frac{\Delta t}{2\Delta x} u_{i-1}^{k}\right) & 1 + \frac{\Delta t}{2\Delta x}u_i^{k} & 0 & \dots  & 0 \\
			0 & - \left(\frac{\Delta t}{2\Delta x} u_{i-1}^{k}\right) & 1 + \frac{\Delta t}{2\Delta x}u_i^{k} & \dots  & 0 \\
	    \vdots & \vdots & \vdots & \ddots & \vdots \\
	    0 & 0 & \dots & - \left(\frac{\Delta t}{2\Delta x} u_{i-1}^{k}\right)  & 1 + \frac{\Delta t}{2\Delta x}u_i^{k}
	\end{bmatrix}.
\end{equation}
