...
\newcommand{\repourl}{www.gitlab.com/bvermeir/book-cfd}
\newcommand{\binderurl}{https://mybinder.org/v2/gl/bvermeir\%2Fbook-cfd/master}
...
\node[inner sep=0pt] (background) at (current page.center) {\includegraphics[width=\paperwidth]{titlepage.pdf}};
\end{tikzpicture}
\vfill
\endgroup
