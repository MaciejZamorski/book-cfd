...
\newcommand{\binderurl}{www.mybinder.org/}
...
{\huge An Open Source Approach}\\[20pt] % Subtitle
{\large Brian C. Vermeire, Carlos A. Pereira, and Hamidreza Karbasian}}}; % Author name
\end{tikzpicture}
\vfill
\endgroup
